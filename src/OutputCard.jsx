...
function OutputCard({btnText, btnLink, btnIcon, btnShape, btnSize, btnStyle, colorQuery, btnColor, btnLocation, isLeft, applyGradient, gradientColorOne, gradientColorTwo}) {
  ...
  const gradientStyle = applyGradient
    ? {
        backgroundImage: `linear-gradient(25deg, #${gradientColorOne}, #${gradientColorTwo})`,
        zIndex: '1000'
      }
    : {
        zIndex: '1000' // gray-500
      };
    console.log(gradientColorOne)
